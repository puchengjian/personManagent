...
Linux环境
-
### jdk1.8，tomcat8.5，MySQL5.7，Redis3.0以上，MyCatServer1.6，Nginx，ftp服务器管理图片
### docker pull puzhengyu/centos 拉取镜像，镜像包含ssh，jdk1.8，tomcat8.5
### docker容器
...
[MyCat压缩包 提取码: bw83](https://pan.baidu.com/s/1Yb78CzEr9Fpqlie-Y1J-4w)
[Redis4.0 提取码: avlo](https://pan.baidu.com/s/1A9G_AzeCbifqYuNaqIeEdQ)
[Linux配置systemctl service步骤 提取码: hson](https://pan.baidu.com/s/17_qWYUhUvi4HJfadWttaug)
[Linux搭建redis 提取码: ybjb](https://pan.baidu.com/s/1ba38HrVj6lbc73yLWqblaA)
[Linux搭建Nginx 提取码: m315](https://pan.baidu.com/s/1rFNz0p_MYZaKCfyvTO1TYw)
[Docker常用命令 提取码: 8swc](https://pan.baidu.com/s/1kb_sd50JIaOXohnQnPVN1w)
[Git常用命令 提取码: 0m4z](https://pan.baidu.com/s/1Rog-JbUPVlTY3g0V7BlRWw)
